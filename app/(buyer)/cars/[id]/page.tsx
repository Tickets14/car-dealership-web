...
export default function CarDetailPage({
  ...
  const whatsappUrl = WHATSAPP_NUMBER
    ? `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(`Hi! I'm interested in the ${fullTitle} (Stock #${car.stock_number}). Is it still available?`)}`
    : null;
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t bg-background/95 backdrop-blur-sm p-3 lg:hidden safe-area-inset-bottom">
        <div className="flex gap-2">
          {car.status === 'available' && (
            <Button
