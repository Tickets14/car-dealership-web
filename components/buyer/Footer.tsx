...
export function Footer() {
  ...
  const address = contactInfo.address || 'Metro Manila, Philippines';
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white">{BUSINESS_NAME}</h3>
            <p className="text-sm leading-relaxed">
              Your trusted car dealership. Quality pre-owned vehicles at fair
              prices with flexible financing options.
            </p>
