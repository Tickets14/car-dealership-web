...
type Step1Input = z.input<typeof sellCarStep1Schema>;
type Step1Data = z.output<typeof sellCarStep1Schema>;
type Step3Input = z.input<typeof sellCarStep3Schema>;
type Step3Data = z.output<typeof sellCarStep3Schema>;
type Step4Input = z.input<typeof sellCarStep4Schema>;
type Step4Data = z.output<typeof sellCarStep4Schema>;

type Step1Form = ReturnType<typeof useForm<Step1Input, unknown, Step1Data>>;
type Step3Form = ReturnType<typeof useForm<Step3Input, unknown, Step3Data>>;
type Step4Form = ReturnType<typeof useForm<Step4Input, unknown, Step4Data>>;
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="space-y-2 rounded-lg border p-4">
        ...
        <div className="grid gap-x-6 gap-y-1 text-sm xl:grid-cols-2">
          <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {filledPhotos.map((p) => (
            <div key={p.label} className="space-y-0.5">
              <div className="relative aspect-square overflow-hidden rounded-md ring-1 ring-border">
                <OptimizedImage
                  src={p.preview!}
                  alt={p.label}
                  fill
...
export default function SellPage() {
  ...
  const step1Form = useForm<Step1Input, unknown, Step1Data>({
  ...
  const step3Form = useForm<Step3Input, unknown, Step3Data>({
  ...
  const step4Form = useForm<Step4Input, unknown, Step4Data>({
  ...
  const handleSubmit = () => {
    ...
    const s1 = step1Form.getValues() as Step1Data;
    const s3 = step3Form.getValues() as Step3Data;
    const s4 = step4Form.getValues() as Step4Data;
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="rounded-xl border bg-card p-5 shadow-sm sm:p-8">
        ...
        {currentStep === 4 && (
          <StepReview
            step1Data={step1Form.getValues() as Step1Data}
            photos={photos}
            step3Data={step3Form.getValues() as Step3Data}
            step4Data={step4Form.getValues() as Step4Data}
            confirmed={confirmed}
